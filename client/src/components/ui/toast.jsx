    ...
    variants: {
      variant: {
        ...
        success:
          ...
          "dark:bg-green-950/20 dark:text-green-100 backdrop-blur-md",

        destructive:
          "border-red-500 bg-red-50 text-red-900 " +
          "dark:bg-red-900/20 dark:text-red-100 backdrop-blur-md",
      },
    },
    defaultVariants: {
      variant: "success",
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  ...
  "absolute right-2 top-2 rounded-md p-1 opacity-70 transition-opacity " +
    ...
    "group-[.destructive]:text-red-600 group-[.destructive]:hover:text-red-800 " +
